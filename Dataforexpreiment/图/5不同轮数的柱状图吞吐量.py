...
data = pd.read_excel('5不同轮数的柱状图的吞吐量.xlsx')
...
# Colors for each protocol using hex codes
colors = {
    'SYNC': '#045275',  # 蓝色
    'SYNC-CSVC': '#089099',  # 橙色
    'SYNC-FS': '#7CCBA2',  # 绿色
...
# Plotting each protocol with specified color and offset
...
# Labels and title
ax.set_xlabel('Transcation Rounds', fontsize=30)
ax.set_ylabel('Throughput(bytes/s)', fontsize=30)
# 添加图例，确保没有重复的图例
# 设置刻度字体大小
