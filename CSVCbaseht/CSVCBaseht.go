...
import (
	CSVCbaseht "code/CSVCbaseht/client"
	"code/CSVCbaseht/shard1"
	"code/CSVCbaseht/shard2"
	"code/CSVCbaseht/shard3"
	"code/CSVCbaseht/shard4"
	"code/CSVCbaseht/shard5"
	"code/CSVCbaseht/shard6"
	"code/CSVCbaseht/shard7"
	"code/config"
	"strconv"
	"sync"
	"time"
...
func main() {
	...
	go CSVCbaseht.ListenForFeedback()
	CSVCbaseht.ExitChan = make(chan bool) // Initialize the exit channel
	go func() {
		CSVCbaseht.StartClient()
	}()
